...
⚠️ Claude Code v${current_version} - Limited Features
   • Context forking: ${SPECKIT_FEATURE_CONTEXT_FORKING}
   • Parallel execution: ${SPECKIT_FEATURE_PARALLEL_EXECUTION}
   • Task dependencies: ${SPECKIT_FEATURE_TASK_DEPENDENCIES}
